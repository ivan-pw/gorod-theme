            ...
            <div class="row">
                ...
                <div class="col-12 offset-md-4 col-md-8">
                    <div class="panel panel-v1 panel-v1__part2 ml-5">
                        ...
                        <div class="bottom">Для того, чтобы Москва развивалась и стала городом для людей, стала ближе к своим жителям, необходимо перестроить систему городского управления и внедрить соучаствующие
                            методы в процесс принятия решений</div>
                    </div>
                </div>
            </div>
