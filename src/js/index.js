...
window.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelector('header nav a.show-menu').addEventListener('click', (e) => {
    e.preventDefault();
    document.querySelector('header nav .mobile-menu').classList.toggle('closed');
  });

  document.querySelector('header nav .mobile-menu a.close').addEventListener('click', (e) => {
    e.preventDefault();
    document.querySelector('header nav .mobile-menu').classList.toggle('closed');
  });
});
